...
<?php
		echo"				
       		  ...
       		  <form enctype='multipart/form-data' class='store-data list-block' role='form' action='bookup.php' method='POST'>
      <ul>
        <li>
       
		            <div class='item-content'>
            <div class='item-media'><i class='icon f7-icons'>book</i></div>
           ...
           <input type='hidden' name='location' value='$location'>
                ...
                <textarea rows='8' cols='30'  placeholder='Let them know...' name='content'></textarea>
				     <p>  <input name='file' type='file' id='file' > 
  </p>
     <div class='item-input'>
