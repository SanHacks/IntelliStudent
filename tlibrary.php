 ...
 $lookwf =$_GET[id];
 	if($user_id){
		...
		$queryrh = "SELECT id,user_id,post,type,role
                              FROM posts 
                              WHERE tribe_id='$lookwf' AND  type='$jpg' OR type='$gif' 
                             ";
						 ...
						 $queryrhe = "SELECT id,user_id,post,type,role
                              FROM posts 
                              WHERE tribe_id='$lookwf' AND type='$video'
                             ";
						 ...
						 $queryrhet = "SELECT id,user_id,post,type,role
                              FROM posts 
                              WHERE tribe_id='$lookwf' AND type='$list'
                             ";
					...
					//	  $queryrhetx = "SELECT id,user_id,post,type,role,roles
                       //       FROM posts 
                      //        WHERE tribe_id='$lookwf' AND roles='$list'
                       //      ";
...
<html>
 ...
 ?>">
    <div class="navbar-inner">
      ...
      <div class="center">Classroom Library</div>
        ...
        <div class="list-block">
		  ...
		  <?php
			...
			echo"		
			  ...
			  <li><a href='thighlights.php?id=$lookwf' class='item-link item-content'>
			...
			echo"		
			  ...
			  <li><a href='tlikes.php?id=$lookwf' class='item-link item-content'>
                <div class='item-media'><i class='icon f7-icons'>layers_fill</i></div>
                <div class='item-inner'>
			...
			echo"		
			  ...
			  <li><a href='tphotos.php?id=$lookwf' class='item-link item-content'>
			...
			echo"		
			  ...
			  <li><a href='tvideos.php?id=$lookwf' class='item-link item-content'>
			...
			echo"		
			  ...
			  <li><a href='taudios.php?id=$lookwf' class='item-link item-content'>
