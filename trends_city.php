 ...
 ?>">
    <div class="navbar-inner">
	  ...
	  " class="back link icon-only"><i class="icon icon-back"></i></a></div>
		...
		echo"<div class='center'>Change location</div>";
		?>
  ...
  <div class="page-content contacts-content">
    <div class="list-block contacts-block">
      <div class="list-group">
		...
		include "connect.php";
		$chi ="SELECT id,province,city
                              FROM location_city Where province = '$use' ORDER BY province ASC Limit 20

                             ";
		$query=mysqli_query($conn, $chi);
	...
	<li>
           ...
           <a href='city-subscriber.php?location=$content>      <div class='item-title'>$content </div></a>
