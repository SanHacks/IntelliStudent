...
if ($_FILES["file"]["type"] == "audio/pdf")
{
	$ext = "pdf";
	$src = $_FILES['file']['tmp_name'];
}else if ($_FILES["file"]["type"] == "audio/pdf")
{
	$ext = "mpeg";
	$src = $_FILES['file']['tmp_name'];
...
if ((($ext == "pdf") ||($ext == "txt") ||($ext == "mpeg") ||($ext == "3gpp") || ($ext == "gif")) && ($_FILES["file"]["size"] < 100000000))
  {
...
exit();
		...
		$picid = $nameof;
		$picturelocation = "userfiles/$picid.$ext";
	    $picturelocations = "userfiles/$nameofs.$ext";
		//move pic
...
exit();;
...
else
	{
	   ...
	   $success = 'success';
header("location: appdate-poll.php?success=$success");
exit();
	}
?><?php ob_end_flush();?>