...
<html>
 ...
 ?>">
  ...
  <div class="page-content contacts-content">
	...
	include "connect.php";
		$yi = "SELECT location,id FROM location
	...
	<li>
           ...
           <a href='location-subscriber.php?location=$content'>      <div class='item-title'>$content </div></a>
		   <a href='trends_pro.php?id=$id'><i>more</i></a>
              </div>
            </div>
          </li>";
