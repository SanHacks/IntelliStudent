...
<a href='upvote.php?comment_id=$comment_id&post=$look&user=$comment_user' style='font-weight:bold;font-size: 14px;color:white;' ><i class='icon f7-icons'>up</i><p>Upvote</p>
";
if($votesup){
echo "$votesup";
}
...
echo "<div class='col-25'>
<a href='downvote.php?comment_id=$comment_id&post=$look' style='font-weight:bold;font-size: 14px;color:white;'><i class='icon f7-icons'>down</i><p>Downvote</p>";
if($votesdown){
echo "$votesdown";
}
echo"</a> </div>";
